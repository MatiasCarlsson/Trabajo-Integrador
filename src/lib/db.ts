...
const supabaseUrl =
  ...
  'https://eedhkrxokjldkxgfrxua.supabase.co';
const supabaseKey =
  import.meta.env.PUBLIC_SUPABASE_ANON_KEY ||
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVlZGhrcnhva2psZGt4Z2ZyeHVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjI5MDM2NTIsImV4cCI6MjA3ODQ3OTY1Mn0.MG4wpL1uzSZJCjpcGcUq9-VYRJMeBpVkFkgo61mnYfU';
